...
import { ArrowLeft, Home, Calendar as CalendarIcon, ChevronLeft, ChevronRight, RefreshCw } from 'lucide-react';
...
const Calendar = () => {
  ...
  const { connectCalendar, isConnected } = useGoogleCalendar();
    ...
    <>
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="pt-16 pl-[188px] pr-[188px] pb-4">
          ...
          <Card className="fintech-chart-container mb-4">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  {isConnected ? 'Sync with Google' : 'Connect Google'}
                </Button>
              </div>
            </CardHeader>
            <CardContent>
