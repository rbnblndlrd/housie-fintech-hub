...
export const FleetVehiclesViewOverlay: React.FC<FleetVehiclesViewOverlayProps> = ({
  ...
  return (
    <OverlayWrapper
      position={position}
      draggable={draggable}
      className={`z-40 transition-all duration-300 ${isClosing ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}
    >
      <Card 
        className="bg-white/95 backdrop-blur-sm border shadow-lg min-w-[340px] max-w-[400px]"
        onMouseEnter={handleUserInteraction}
        onClick={handleUserInteraction}
      >
        <div className="p-4">
          {/* Header */}
          <div className="flex items-center justify-between mb-4" data-draggable-header="true">
