...
const LocationAnalyticsOverlay: React.FC<LocationAnalyticsOverlayProps> = ({
  ...
  return (
    <Card className="w-72 bg-white/95 backdrop-blur-sm shadow-lg pointer-events-auto">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2" data-draggable-header={draggable}>
            {draggable && <GripVertical className="h-4 w-4 cursor-grab" data-grip="true" />}
            <MapPin className="h-4 w-4" />
