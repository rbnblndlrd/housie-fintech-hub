...
const UberEatsStyleHero = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-orange-200 via-orange-300 to-orange-400 min-h-[60vh] flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 text-center">
        ...
        <div className="bg-white rounded-lg shadow-xl p-2 flex flex-col sm:flex-row gap-2 max-w-2xl mx-auto">
          {/* Location Input */}
        ...
        <p className="mt-4 text-black/70">
          Or{' '}
          <button className="underline font-medium text-black hover:text-black/80">
            Sign In
          </button>
        </p>
      </div>
