...
export const UserTypeSelector = ({ onUserTypeSelect, selectedUserType }: UserTypeSelectorProps) => {
  ...
  return (
    <section className="py-16 lg:py-24 px-2 sm:px-4 relative bg-green-700 animated-texture">
      <div className="max-w-[95vw] lg:max-w-[90vw] xl:max-w-[85vw] mx-auto relative">
        <div className="text-center mb-16 lg:mb-20">
          {/* Mascot Speech Bubble for Section */}
          <div className="inline-block relative">
            <div className="bg-cream border-3 border-black rounded-3xl px-8 lg:px-10 py-6 lg:py-8 shadow-2xl relative transform hover:scale-105 transition-transform duration-300">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-16">
          {userTypeOptions.map((option) => (
            <Card 
              key={option.id}
              className={`bg-cream border-3 border-black cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-3 rounded-2xl p-6 lg:p-8 relative overflow-hidden ${
