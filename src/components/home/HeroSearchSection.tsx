...
const HeroSearchSection = () => {
  ...
  const dashboardPosition = { x: 2156, y: 450 };
      ...
      <Link to="/dashboard">
        ...
        >
          <div className="text-white hover:scale-105 transition-transform duration-300 flex flex-col items-center h-full w-full justify-center">
            <span className="font-sans text-4xl font-extrabold tracking-wider uppercase">DASHBOARD</span>
            <div className="text-5xl mt-1 tracking-wider">➤➤➤</div>
          </div>
        </div>
      </Link>
