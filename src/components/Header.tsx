      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
              ...
              {user ? (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-64">
                    ...
                    <DropdownMenuItem asChild>
                      <Link to="/calendar" className="flex items-center space-x-2 px-3 py-2">
                        <Calendar className="h-4 w-4" />
                        <span>Calendrier</span>
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link to="/booking-management" className="flex items-center space-x-2 px-3 py-2">
                        <Calendar className="h-4 w-4" />
                    ...
                    <DropdownMenuItem asChild>
                      <Link to="/analytics" className="flex items-center space-x-2 px-3 py-2">
                    ...
                    <DropdownMenuItem asChild>
                      <Link to="/booking-history" className="flex items-center space-x-2 px-3 py-2">
                        <BarChart3 className="h-4 w-4" />
          ...
          <div className={`md:hidden absolute top-full left-0 right-0 bg-white dark:bg-dark-primary border-b border-border py-4 px-6 flex flex-col space-y-3 shadow-[0_8px_30px_-4px_rgba(0,0,0,0.2)] rounded-b-2xl ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
            ...
            {/* Mobile Auth Section */}
            {user ? (
              <div className="flex flex-col items-start space-y-3 pt-4 border-t">
