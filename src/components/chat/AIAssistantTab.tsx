      ...
      <div className="h-full flex flex-col">
          ...
          {debugInfo && !isDownloading && webLLMReady && (
            <Alert className="mb-3">
              ...
              <AlertDescription className="text-sm">
                {debugInfo}
                {retryCount > 0 && <span className="text-blue-600 ml-2">(Retry {retryCount}/3)</span>}
              </AlertDescription>
            </Alert>
          )}
        ...
        {sessions.length === 0 && (
          <div className="p-4">
            ...
            {/* Enhanced Test Commands Section */}
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
              <h5 className="font-medium text-blue-900 dark:text-blue-100 mb-2">🧪 Production Test Commands</h5>
              <div className="text-xs text-blue-700 dark:text-blue-300 space-y-1">
                ...
                {webLLMError && (
                  <div className="text-red-600 font-medium">• WebLLM Error - Using fallback responses</div>
                )}
              </div>
            </div>
          </div>
