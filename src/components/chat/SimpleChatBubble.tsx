...
import { WebLLMErrorBoundary } from '@/components/WebLLMErrorBoundary';
      ...
      fallback={
        <div className="fixed bottom-6 right-6 z-50">
          <Button
            ...
            className="relative rounded-full w-16 h-16 shadow-lg bg-red-600 hover:bg-red-700"
          >
          ...
          {!isOpen ? (
            <Button
              ...
              className={cn(
                ...
                webLLMError ? "bg-yellow-600 hover:bg-yellow-700" : "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700",
              ...
              <div className="bg-gray-50 dark:bg-gray-800 flex border-b border-gray-200 dark:border-gray-700">
                ...
                >
                  ...
                  <Badge variant="outline" className={`text-xs ${
                    ...
                    {webLLMReady ? 'WebLLM' : webLLMError ? 'Fallback' : 'Loading'}
                  </Badge>
                </button>
              </div>
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                ...
                {activeTab === 'ai' && (
                  <div className="mt-2 text-xs text-gray-500 dark:text-gray-400 text-center">
                    💡 Try: "test webllm", "tax?", "pets?", or "show me colors"
                    {webLLMError && <span className="text-yellow-600 ml-2">(Fallback Mode)</span>}
                  </div>
                )}
              </div>
            </div>
