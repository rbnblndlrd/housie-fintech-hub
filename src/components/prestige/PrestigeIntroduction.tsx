...
const PrestigeIntroduction = () => {
  return (
    <div className="space-y-6">
      {/* Main Explanation */}
      <Card className="bg-slate-800/90 backdrop-blur-sm border border-slate-700 shadow-lg">
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-slate-700/60 rounded-lg border border-slate-600">
              <h4 className="font-medium mb-2 flex items-center gap-2 text-slate-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-slate-800/90 backdrop-blur-sm border border-slate-700">
          ...
          <CardContent className="pt-0">
            ...
            <div className="space-y-2">
              <div className="text-xs font-medium text-slate-200">Example:</div>
              <div className="text-xs bg-slate-700/60 rounded p-2 border border-slate-600 text-slate-200">
        ...
        <Card className="bg-slate-800/90 backdrop-blur-sm border border-slate-700">
          ...
          <CardContent className="pt-0">
            ...
            <div className="space-y-2">
              <div className="text-xs font-medium text-slate-200">Three Types:</div>
              <div className="text-xs space-y-1">
                <div className="bg-slate-700/60 rounded p-1 border border-slate-600 text-slate-200">Quality</div>
                <div className="bg-slate-700/60 rounded p-1 border border-slate-600 text-slate-200">Reliability</div>
                <div className="bg-slate-700/60 rounded p-1 border border-slate-600 text-slate-200">Courtesy</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-slate-800/90 backdrop-blur-sm border border-slate-700">
          ...
          <CardContent className="pt-0">
            ...
            <div className="space-y-2">
              <div className="text-xs font-medium text-slate-200">Examples:</div>
              <div className="text-xs bg-slate-700/60 rounded p-2 border border-slate-600 text-slate-200">
      ...
      <Card className="bg-slate-800/90 backdrop-blur-sm border border-slate-700 shadow-lg">
        ...
        <CardContent>
          ...
          <div className="space-y-2">
            <div className="p-3 bg-slate-700/60 rounded-lg border border-slate-600 text-sm text-slate-200">
