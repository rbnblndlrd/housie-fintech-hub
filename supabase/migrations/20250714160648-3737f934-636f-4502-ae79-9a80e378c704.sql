...
('road-warrior', 'Road Warrior', 'Performance', 'Distance means nothing to the determined.', '🚙', '["mobility", "endurance"]', '[{"type": "distance_from_home", "value": 25, "unit": "km"}, {"type": "daily_distance", "value": 50, "unit": "km"}]'),
('clockwork', 'Clockwork', 'Behavior', 'Precision is your middle name.', '⏰', '["punctuality", "reliability"]', '[{"type": "early_arrivals", "value": 10, "unit": "count"}]'),
('blitzmaster', 'Blitzmaster', 'Performance', 'Speed and quality in perfect harmony.', '⚡', '["speed", "efficiency"]', '[{"type": "jobs_per_day", "value": 5, "unit": "count"}]'),
('faithful-return', 'Faithful Return', 'Loyalty', 'They know they can count on you.', '🔄', '["loyalty", "repeat_client"]', '[{"type": "repeat_bookings", "value": 3, "unit": "count", "same_client": true}]'),
('tier-1-trusted', 'Tier 1 Trusted', 'Loyalty', 'VIP status with your best clients.', '👑', '["vip", "trusted"]', '[{"type": "client_tier", "value": "tier_1", "bookings": 5}]'),
('solo-operator', 'Solo Operator', 'Crew', 'One person army, maximum efficiency.', '🎯', '["independence", "solo"]', '[{"type": "solo_jobs", "value": 10, "unit": "count"}]'),
('one-woman-army', 'One-Woman Army', 'Crew', 'When the going gets tough, you go alone.', '💪', '["resilience", "solo", "challenge"]', '[{"type": "solo_jobs_difficult", "value": 3, "unit": "count"}]'),
('builder', 'Builder', 'Crew', 'You bring people together to get things done.', '🏗️', '["leadership", "crew", "coordination"]', '[{"type": "crew_jobs_organized", "value": 3, "unit": "count"}]'),
('cleanup-queen', 'Cleanup Queen', 'Behavior', 'Perfection is in the details.', '✨', '["quality", "attention_to_detail"]', '[{"type": "photo_quality_score", "value": 95, "unit": "percent"}]'),
('early-bird', 'Early Bird', 'Behavior', 'The early bird gets the best jobs.', '🐦', '["punctuality", "morning"]', '[{"type": "early_morning_jobs", "value": 10, "unit": "count", "time": "before_8am"}]'),
('no-show-slayer', 'No-Show Slayer', 'Behavior', 'When others fail, you step up.', '🦸', '["reliability", "backup", "hero"]', '[{"type": "emergency_coverage", "value": 5, "unit": "count"}]'),
('five-star-sweep', '5-Star Sweep', 'Reputation', 'Excellence is your only standard.', '⭐', '["excellence", "reviews"]', '[{"type": "five_star_reviews", "value": 10, "unit": "count", "consecutive": true}]'),
('reviewed-royalty', 'Reviewed Royalty', 'Reputation', 'Your reputation speaks for itself.', '👸', '["reputation", "reviews", "quality"]', '[{"type": "total_reviews", "value": 25, "unit": "count", "average_rating": 4.5}]'),
('night-shift', 'Night Shift', 'Performance', 'When the city sleeps, you work.', '🌙', '["night_work", "dedication"]', '[{"type": "night_jobs", "value": 5, "unit": "count", "time": "after_9pm"}]'),
('storm-rider', 'Storm Rider', 'Performance', 'Weather is just another challenge.', '⛈️', '["weather", "resilience"]', '[{"type": "bad_weather_jobs", "value": 3, "unit": "count"}]'),
('comeback-kid', 'Comeback Kid', 'Behavior', 'You always bounce back stronger.', '🔙', '["resilience", "recovery"]', '[{"type": "recovery_after_difficult_job", "value": 2, "unit": "count"}]'),
('weekend-warrior', 'Weekend Warrior', 'Performance', 'Your weekends are their solutions.', '🏃', '["weekend", "availability"]', '[{"type": "weekend_jobs", "value": 8, "unit": "count"}]'),
('local-legend', 'Local Legend', 'Reputation', 'Your neighborhood knows your name.', '🏘️', '["local", "reputation"]', '[{"type": "local_area_dominance", "value": 20, "unit": "jobs", "radius": 5}]'),
('first-responder', 'First Responder', 'Behavior', 'First to respond, first to deliver.', '🚨', '["speed", "response_time"]', '[{"type": "response_time", "value": 15, "unit": "minutes", "count": 10}]'),
('efficiency-expert', 'Efficiency Expert', 'Performance', 'Time is money, and you save both.', '📊', '["efficiency", "time_management"]', '[{"type": "under_estimated_time", "value": 5, "unit": "jobs", "percentage": 20}]');
