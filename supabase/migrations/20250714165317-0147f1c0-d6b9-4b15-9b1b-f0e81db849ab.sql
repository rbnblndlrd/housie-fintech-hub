-- Canon Echo System Migration (Fixed)
...
-- Reactions policies
CREATE POLICY "Users can create canon echo reactions" 
ON public.canon_echo_reactions 
FOR INSERT 
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can view canon echo reactions on public echoes" 
ON public.canon_echo_reactions 
FOR SELECT 
USING (
  echo_id IN (
...
CREATE POLICY "Users can delete their own canon echo reactions" 
ON public.canon_echo_reactions 
FOR DELETE 
USING (auth.uid() = user_id);
